...
+ (NSURLSessionDataTask *)GetListWithBlock:(void (^)(NSMutableArray *posts, NSError *error))block noNetWork:(void(^)())noNetWork{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"api/session/list"];
    NSLog(@"=====%@",urlStr);
...
+ (NSURLSessionDataTask *)DelMessageListWithBlock:(void (^)(NSMutableArray *posts, NSError *error))block dic:(NSMutableDictionary *)dic noNetWork:(void(^)())noNetWork{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"api/session/remove"];
    NSLog(@"=====%@",urlStr);
    return [[ChatNetAPIClient sharedNewClient] POST:urlStr parameters:dic success:^(NSURLSessionDataTask * __unused task, id JSON) {
        NSLog(@"JSON===>%@",JSON);
        if([[NSString stringWithFormat:@"%@",JSON[@"status"][@"statusCode"]]isEqualToString:@"200"]){
...
+ (NSURLSessionDataTask *)LogoutWithBlock:(void (^)(NSMutableArray *posts, NSError *error))block dic:(NSMutableDictionary *)dic noNetWork:(void(^)())noNetWork{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"api/session/logout"];
    NSLog(@"=====%@",urlStr);
    return [[ChatNetAPIClient sharedNewClient] POST:urlStr parameters:dic success:^(NSURLSessionDataTask * __unused task, id JSON) {
        NSLog(@"JSON===>%@",JSON);
        if([[NSString stringWithFormat:@"%@",JSON[@"status"][@"statusCode"]]isEqualToString:@"200"]){
...
+ (NSURLSessionDataTask *)LeaveWithBlock:(void (^)(NSMutableArray *posts, NSError *error))block dic:(NSMutableDictionary *)dic noNetWork:(void(^)())noNetWork{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"api/session/leave"];
    NSLog(@"=====%@",urlStr);
    return [[ChatNetAPIClient sharedNewClient] POST:urlStr parameters:dic success:^(NSURLSessionDataTask * __unused task, id JSON) {
        NSLog(@"JSON===>%@",JSON);
        if([[NSString stringWithFormat:@"%@",JSON[@"status"][@"statusCode"]]isEqualToString:@"200"]){
...
+ (NSURLSessionDataTask *)DismissWithBlock:(void (^)(NSMutableArray *posts, NSError *error))block dic:(NSMutableDictionary *)dic noNetWork:(void(^)())noNetWork{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"api/group/dismiss"];
    NSLog(@"=====%@",urlStr);
    return [[ChatNetAPIClient sharedNewClient] POST:urlStr parameters:dic success:^(NSURLSessionDataTask * __unused task, id JSON) {
        NSLog(@"JSON===>%@",JSON);
        if([[NSString stringWithFormat:@"%@",JSON[@"status"][@"statusCode"]]isEqualToString:@"200"]){
...
+ (NSURLSessionDataTask *)forwardWithBlock:(void (^)(NSMutableArray *, NSError *))block dic:(NSMutableDictionary *)dic noNetWork:(void (^)())noNetWork{
    if (![ConnectionAvailable isConnectionAvailable]) {
        if (noNetWork) {
            noNetWork();
        }
    ...
    NSString *urlStr = [NSString stringWithFormat:@"api/chatlog/forward"];
    NSLog(@"=====%@",urlStr);
    return [[ChatNetAPIClient sharedNewClient] POST:urlStr parameters:dic success:^(NSURLSessionDataTask * __unused task, id JSON) {
        NSLog(@"JSON===>%@",JSON);
        if([[NSString stringWithFormat:@"%@",JSON[@"status"][@"statusCode"]]isEqualToString:@"200"]){
