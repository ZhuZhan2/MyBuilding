//
//  RequirementInfoCooperationView.m
//  ZhuZhan
//
...
@interface RequirementInfoCooperationView ()<UITextViewDelegate>

@end

@implementation RequirementInfoCooperationView
...
+ (RequirementInfoCooperationView*)cooperationViewWithRequirementDescribe:(NSString*)requirementDescribe{
    RequirementInfoCooperationView* projectView = [[RequirementInfoCooperationView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, 375)];
